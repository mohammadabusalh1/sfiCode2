...
<div class="container text-center" >
  <form method="post">
    ...
    <div class="mb-3 row">
    <label for="inputUsername" class="col-lg-2 col-md-3 col-sm-12 col-form-label">إسم البرنامج</label>
  ...
  <div class="row" style="text-align:left ;">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12">
          <button type="submit" class="btn btn-success" name="bt_add">أضف برنامج جديد </button>
        </div>
      </div>
      <br>
...
<table class="table table-striped" id="table">
  ...
  <tbody>
    <?php
      ...
      <th scope="row">'.$b.'</th>
      <td>'.$n['name'].'</td>
      <td><a href="programRemove.php?id='.$n['id'].'" class="btn btn-danger">حذف</a></td>
    </tr>'; 
    $b++;
  }
      }else{

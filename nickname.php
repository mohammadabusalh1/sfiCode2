  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav" style="margin-right: -2vw;">
      <ul class="navbar-nav" style="width: 100%;">
        ...
        <li class="nav-item">
          <b><a class="nav-link" href="programs.php" >البرامج</a></b>
        </li>
...
<div class="container text-center" >
  <form method="post">
    ...
    <div class="mb-3 row">
    <label for="inputUsername" class="col-lg-2 col-md-3 col-sm-12 col-form-label">المسمى الوظيفي</label>
  ...
  <div class="row" style="text-align:left ;">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12">
          <button type="submit" class="btn btn-success" name="bt_add">أضف لقب جديد </button>
        </div>
      </div>
      <br>
  ...
  <?php 
   ...
   if (isset($_POST['bt_add'])) {
    $nick = $_POST['nick'];
    if (!empty($nick)){
      $sql = "INSERT INTO `nicknames` (`Nickname`) VALUES ('$nick')";
...
<table class="table table-striped" id="table">
  ...
  <tbody>
    <?php
      ...
      <th scope="row">'.$b.'</th>
      <td>'.$n['Nickname'].'</td>
      <td><a href="nickNameRemove.php?id='.$n['id'].'" class="btn btn-danger">حذف</a></td>
    </tr>'; 
    $b++;
  }
      }else{

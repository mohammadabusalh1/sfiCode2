...
<body dir="rtl">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav" style="margin-right: -2vw;">
        <ul class="navbar-nav" style=" width: 100%;">
          ...
          <li class="nav-item">
           <b> <a class="nav-link" href="princpl.php">المشاركين</a></b>
          </li>
          <li class="nav-item">
  ...
  <div class="container text-center">
    <form method="post">
      ...
      <div class="mb-3 row">
        <label for="inputUsername" class="col-sm-12 col-md-2 col-form-label">إسم المشارك</label>
      ...
      <div class="row" style="text-align:left ;">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
          <button type="submit" class="btn btn-success" name="bt_add">أضف مشارك جديد </button>
        </div>
      </div>
...
<form action="users.php" method="post">
      ...
      <th scope="row">' . $b . '</th>
      <td>' . $n['name'] . '</td>
      <td><a href="participantsRemove.php?id=' . $n['id'] . '" class="btn btn-danger">حذف</a></td>
    </tr>';
              $b++;
            }
          } else {
  ...
  <footer>
    <div id="footer">
      <img src="img/sfi-logo.png" style=" width: 220px; height: 50px;">
      <br>

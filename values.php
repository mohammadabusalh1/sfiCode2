...
<body dir="rtl" style="background-color: #DFF6FF;">
    ...
    border-color: rgba(0, 0, 0, 0.80);">
                    <p class="content" style="font-size: 24px; line-height: 100%; margin-top: 0.2vw; color: rgba(37, 109, 133, 1);">الفلاتر</p>
    ...
    <div class="row mb-4">
        <div class="col-4"></div>
        <div class="col-4">
            <button id="show" style="width: 80%;" class="btn btn-success"><b>أظهر التقارير</b></button>
        </div>
    </div>
    </div>
    <br><br>
    ...
    <script>
        $("#show").click(function() {
           ...
           window.location.replace("showReport.php");
        });
    </script>
    <!-- footer -->
    <footer class="footer">
